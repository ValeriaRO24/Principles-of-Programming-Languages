{-|
Module:      A3Godel
Description: Reference Godel interpreter for Assignment 3
Copyright: (c) University of Toronto, 2023
               CSC324 Principles of Programming Languages, Fall 2023

This module contains the (non-CPS) version of the Godel interpreter, along
...
------------------------------------------------------------------------------
-- Data Definitions: the (non-CPS) Godel language
------------------------------------------------------------------------------
...
-- | The interpreter `eval` for Godel, which takes an environment
